...
label_wheels_tag = canvas.create_text(50, 305, font=('Times', '16', 'bold'), text="Wheels :")
...
def myCardDetails():
    ...
    wheels = ["3 wheels", "4 wheels", "10,00,00,00,00,00,000 wheels"]
    print(wheels)
    print(type(wheels))
...
label_wheels_window = canvas.create_window(65, 252, anchor=CENTER, window=label_wheels)
canvas.pack()
